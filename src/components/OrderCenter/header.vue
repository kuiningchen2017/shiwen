<template>
  <div class="header">
    ...
    <div class="headbox">
      ...
      <li>
        <p @click="pay" :class="{ active: study}">待付款</p>
        <span v-show="study"></span>
      </li>
      <li>
        <p @click="comment" :class="{ active: over }">待评论</p>
...
export default {
  ...
  methods: {
    ...
    pay () {
      this.$router.push('/ordercenter/pay')
      this.all = false
      this.study = true
      this.over = false
    },
    comment () {
      this.$router.push('/ordercenter/comment')
      this.all = false
      this.study = false
      this.over = true
    }
  ...
  mounted () {
    if (this.$route.path === '/ordercenter/pay') {
      this.all = false
      this.study = true
      this.over = false
    } else if (this.$route.path === '/ordercenter/comment') {
      this.all = false
      this.study = false
      this.over = true
    }
