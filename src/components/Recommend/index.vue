    ...
    <div class="content-top">
      <li>
        <p class="tab" :class="{ active: code }" @click="toggleTab('ercode')">
          推荐二维码</p><span v-show="code"></span>
      </li>
      <li>
      <p class="tab" :class="{ active: list}" @click="toggleTab('list')">推荐列表</p><span v-show="list"></span>
      </li>
    </div>
...
<script>
import ercode from '@/components/Recommend/code'
import list from '@/components/Recommend/list'
export default {
  data () {
    return {
